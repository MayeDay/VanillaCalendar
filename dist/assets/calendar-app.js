...
;
          if (!runningTests) {
            require("calendar-app/app")["default"].create({"name":"calendar-app","version":"0.0.0+cb819ee6"});
          }
